...
<body>
    ...
    <!-- <input type="text" id="searchInput" placeholder="Search by name..." oninput="filterNames()">
    <br> -->
        ...
        <div class="container">
            <table class="table table-bordered table-striped table-hover">
                ...
                if (isset($_POST['submit'])) {
                    ...
                    $sql = "SELECT * FROM `credit_order` WHERE id='$search'";
                        ...
                        <table id="myTable" class="custom-table">
                            ...
                            <tbody>
                                ...
                                include_once('../database.php');
                                 $sql = "SELECT * FROM accounting_credit_order ORDER BY created_at DESC";
