...
// Function to filter data based on category and month
// function filterData($category, $month, $conn)
// {
//     $query = "SELECT * FROM cash_order";

//     if ($category !== 'all') {
//         $query .= " WHERE business_enterprise='$category'";
//         if ($month !== 'all') {
...
//             // Your table row rendering code here
//         }
//     } else {
...
<body>
                ...
                <div class="table-container">
                    <table id="myTable" class="custom-table">
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT * FROM cash_order ORDER BY created_at DESC  LIMIT 10";
    ...
    <div class="table-container" style="display: none;" id="allCategory">
        <table id="myTable" class="custom-table">
            <thead>
                <tr>
                    <th>Name</th>
            ...
            <tbody>
                <?php
                include_once('../../database.php');
                $sql = "SELECT * FROM cash_order ORDER BY created_at ";
...
// SELECT * FROM cash_order WHERE MONTH(created_at) = 11 AND YEAR(created_at) = 2023;
                ...
                $query = "SELECT * FROM cash_order WHERE business_enterprise='Rice Production' ORDER BY created_at DESC";
                $query_run = mysqli_query($conn, $query);
        ...
        <script>
            ...
            function filterData() {
                ...
                $.ajax({
                    type: "POST",
                    url: "../collections/fetch_monthly_data.php", // Replace with the actual filename where you put the PHP code
...
// SELECT * FROM cash_order WHERE MONTH(created_at) = 11 AND YEAR(created_at) = 2023;
                ...
                $query = "SELECT * FROM cash_order WHERE business_enterprise='Farm Machineries- Harvester'";
                $query_run = mysqli_query($conn, $query);
        ...
        <script>
            ...
            function filterDataHarvester() {
                ...
                $.ajax({
                    type: "POST",
                    url: "../collections/fetch_harvester_monthly_data.php", // Replace with the actual filename where you put the PHP code
...
// SELECT * FROM cash_order WHERE MONTH(created_at) = 11 AND YEAR(created_at) = 2023;
                ...
                $query = "SELECT * FROM cash_order WHERE business_enterprise='Farm Machineries- Rotovator'";
                $query_run = mysqli_query($conn, $query);
        ...
        <script>
            ...
            function filterDataRotovator() {
                ...
                $.ajax({
                    type: "POST",
                    url: "../collections/fetch_rotovator_monthly_data.php", // Replace with the actual filename where you put the PHP code
...
// SELECT * FROM cash_order WHERE MONTH(created_at) = 11 AND YEAR(created_at) = 2023;
                ...
                $query = "SELECT * FROM cash_order WHERE business_enterprise='Turmeric Egg'";
                $query_run = mysqli_query($conn, $query);
        ...
        <script>
            ...
            function filterDataTurmericEgg() {
                ...
                $.ajax({
                    type: "POST",
                    url: "../collections/fetch_TurmericEgg_monthly_data.php", // Replace with the actual filename where you put the PHP code
...
// SELECT * FROM cash_order WHERE MONTH(created_at) = 11 AND YEAR(created_at) = 2023;
                ...
                $query = "SELECT * FROM cash_order WHERE business_enterprise='Fishpond Production'";
                $query_run = mysqli_query($conn, $query);
        ...
        <script>
            function filterDataFishpondProduction() {
                ...
                $.ajax({
                    type: "POST",
                    url: "../collections/fetch_FishpondProduction_monthly_data.php", // Replace with the actual filename where you put the PHP code
...
// SELECT * FROM cash_order WHERE MONTH(created_at) = 11 AND YEAR(created_at) = 2023;
        ...
        <script>
            function filterDataHatchery() {
                ...
                $.ajax({
                    type: "POST",
                    url: "../collections/fetch_Hatchery_monthly_data.php", // Replace with the actual filename where you put the PHP code
...
// SELECT * FROM cash_order WHERE MONTH(created_at) = 11 AND YEAR(created_at) = 2023;
                ...
                $query = "SELECT * FROM cash_order WHERE business_enterprise='Swine Production'";
                $query_run = mysqli_query($conn, $query);
        ...
        <script>
            function filterDataSwineProduction() {
                ...
                $.ajax({
                    type: "POST",
                    url: "../collections/fetch_SwineProduction_monthly_data.php", // Replace with the actual filename where you put the PHP code
...
// SELECT * FROM cash_order WHERE MONTH(created_at) = 11 AND YEAR(created_at) = 2023;
                ...
                $query = "SELECT * FROM cash_order WHERE business_enterprise='Poultry Production-small ruminants'";
                $query_run = mysqli_query($conn, $query);
        ...
        <script>
            function filterDataPoultryProduction() {
                ...
                $.ajax({
                    type: "POST",
                    url: "../collections/fetch_PoultryProduction_monthly_data.php", // Replace with the actual filename where you put the PHP code
...
// SELECT * FROM cash_order WHERE MONTH(created_at) = 11 AND YEAR(created_at) = 2023;
                ...
                $query = "SELECT * FROM cash_order WHERE business_enterprise='Mango Production'";
                $query_run = mysqli_query($conn, $query);
        ...
        <script>
            function filterDataMangoProduction() {
                ...
                $.ajax({
                    type: "POST",
                    url: "../collections/fetch_MangoProduction_monthly_data.php", // Replace with the actual filename where you put the PHP code
...
// SELECT * FROM cash_order WHERE MONTH(created_at) = 11 AND YEAR(created_at) = 2023;
                ...
                $query = "SELECT * FROM cash_order WHERE business_enterprise='Vegetable Production'";
                $query_run = mysqli_query($conn, $query);
        ...
        <script>
            function filterDataVegetableProduction() {
                ...
                $.ajax({
                    type: "POST",
                    url: "../collections/fetch_VegetableProduction_monthly_data.php", // Replace with the actual filename where you put the PHP code
    ...
    <?php
    // Function to render tables based on category
    function renderTable($category)
    {
        global $conn;

        $query = "SELECT * FROM cash_order WHERE business_enterprise='$category'";
        $query_run = mysqli_query($conn, $query);
