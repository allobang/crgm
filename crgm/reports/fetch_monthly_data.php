...
$cashOrderQuery1 = "SELECT totalAmount FROM cash_order WHERE business_enterprise='Rice Production' AND YEAR(created_at) = 2024 AND MONTH(created_at) = :selectedMonth";

// Query to fetch 'amount' column from 'credit_order' table
$creditOrderQuery1 = "SELECT totalAmount FROM credit_order WHERE business_enterprise='Rice Production' AND YEAR(created_at) = 2024 AND MONTH(created_at) = :selectedMonth";

$expensesQuery1 = "SELECT expenses FROM expenses_data WHERE business_enterprise='Rice Production' AND YEAR(created_at) = 2024 AND MONTH(created_at) = :selectedMonth";
...
echo "<tr>
        ...
        <td>" . number_format($totalProfit1, 2, '.', ',') . "</td>
                ...
                $cashOrderQuery2 = "SELECT totalAmount FROM cash_order WHERE business_enterprise='Farm Machineries- Harvester' AND YEAR(created_at) = 2024 AND MONTH(created_at) = :selectedMonth";

                // Query to fetch 'amount' column from 'credit_order' table
                $creditOrderQuery2 = "SELECT totalAmount FROM credit_order WHERE business_enterprise='Farm Machineries- Harvester' AND YEAR(created_at) = 2024 AND MONTH(created_at) = :selectedMonth";

                $expensesQuery2 = "SELECT expenses FROM expenses_data WHERE business_enterprise='Farm Machineries- Harvester' AND YEAR(created_at) = 2024 AND MONTH(created_at) = :selectedMonth";
                ...
                echo "<tr>
                        ...
                        <td>" . number_format($totalCreditAmount, 2, '.', ',') . "</td>
                        <td>" . number_format($totalCashAmount, 2, '.', ',') . "</td>
                        <td>" . number_format($totalSales, 2, '.', ',') . "</td>
                        <td>" . number_format($totalExpensesAmount, 2, '.', ',') . "</td>
