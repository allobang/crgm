...
require("../../database.php"); // Make sure this file contains database connection details
...
<head>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.6-rc.0/css/select2.min.css" rel="stylesheet" />
...
<body>
    ...
    <select id="selectMonth" class="form-select form-control" onchange="filterData()">
        <option selected value="allMonths" >All Months</option>
    ...
    <table class="table table-bordered table-striped table-hover">
        ...
        <tbody id="monthlyData">
            ...
            try {
                ...
                // Sample code for fetching data from 'credit_order'
