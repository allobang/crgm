				...
				<div class="container-fluid">
					<form method="POST" action="edit.php">
						...
						<div class="row form-group">
							...
							<div class="col-sm-10">
								<select id="mySelect" class="form-select form-control form-control-lg" name="business_enterprise" required value="<?php echo $row['business_enterprise:']; ?>">
									...
									<option value="Poultry Production-small ruminants">Poultry Production-smallruminants</option>
						...
						<div class="row form-group">
							<div class="col-sm-2">
								<label class="control-label modal-label">ornumber:</label>
							</div>
							<div class="col-sm-10">
