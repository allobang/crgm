    ...
    <header class="rounded">
        ...
        <nav class="menu">
            <ul class="main-menu">
                ...
                <li class="has-submenu" id="indvlmenu"><a href="#">Collections</a>
                    <ul class="submenu">
                        <li id="indvlmenu2"><a href="agri_based_enterprise.php">Sales</a>
                        <li id="indvlmenu2"><a href="agri_based_enterprise.php">Account Receivables</a>
