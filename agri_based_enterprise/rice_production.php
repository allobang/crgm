<button onclick="riceProduction()" class="btn btn-success ">Rice Production</button>

<table id="riceProduction" style="display: none;" class="table table-bordered table-striped table-hover">
    <thead class="table ">
        <tr>
...
<script>
    function riceProduction() {
        var table = document.getElementById("riceProduction");
