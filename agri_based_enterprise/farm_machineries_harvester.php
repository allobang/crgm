<button onclick="machineriesHarvester()" class="btn btn-success ">Farm Machineries - Harvester</button>
...
// SELECT * FROM cash_order WHERE MONTH(created_at) = 11 AND YEAR(created_at) = 2023;
            ...
            // $query = "SELECT * FROM cash_order WHERE MONTH(created_at) = 11 AND YEAR(created_at) = 2023;";
